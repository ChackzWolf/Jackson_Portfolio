      ...
      <div className="container">
        ...
        <div className="max-w-4xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            className="flex flex-col sm:justify-center items-center md:items-start">
              <h3 className="text-2xl font-bold text-portfolio-navy mb-4">Contact Information</h3>
              <p className="text-gray-600 mb-6 mx-5 md:mx-0">
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <div className="w-7 h-7 rounded-full bg-portfolio-lightYellow/10 flex items-center justify-center mr-3 text-portfolio-lightYellow">
