...
const skillsData: SkillCategory[] = [
  ...
  },
  {
    ...
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>`
  },
  {
    title: "DevOps & Tools",
    skills: ["Git", "GitHub", "Docker", "Kubernetes", "Helm-chart", "AWS", "EC2", "Google Cloud Run", "Vercel", "Render", "CI/CD"],
    icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="4" y1="9" x2="20" y2="9"></line><line x1="4" y1="15" x2="20" y2="15"></line><line x1="10" y1="3" x2="8" y2="21"></line><line x1="16" y1="3" x2="14" y2="21"></line></svg>`
  },
  {
    title: "Soft Skills",
            ...
            <Card
              ...
              <CardContent className="p-6">
                <div className="flex items-center mb-4 justify-center md:justify-start">
                  <div className="w-7 h-7 rounded-full bg-portfolio-lightYellow/10 flex items-center justify-center mr-3 text-portfolio-lightYellow" dangerouslySetInnerHTML={{ __html: category.icon }}></div>
